...
git add README.md docs .gitignore demand_forecast/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://adb-1455354653050080.0.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-1455354653050080.0.azuredatabricks.net#setting/accounts). If
...
If you want to use different catalog names, please update the target names declared in the[demand-forecast/databricks.yml](../demand_forecast/databricks.yml) file.
...
Follow the instructions in [demand-forecast/resources/README.md](../demand_forecast/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../demand_forecast/resources/README.md)  to propose, test, and deploy
