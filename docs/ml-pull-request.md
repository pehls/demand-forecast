...
Opening a pull request will trigger a[workflow](../.github/workflows/demand-forecast-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-1455354653050080.0.azuredatabricks.net/explore/data/models/staging/demand-forecast/demand-forecast-model)
* [Prod model in UC](https://adb-1455354653050080.0.azuredatabricks.net/explore/data/models/prod/demand-forecast/demand-forecast-model)
. 
