...
# ``demand_forecast/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-demand-forecast-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.demand_forecast_models.demand-forecast-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.demand_forecast_models.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.demand_forecast_models.trip_dropoff_features",
