...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``demand_forecast/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in demand-forecast/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in demand-forecast/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-demand-forecast-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.demand_forecast_models.demand-forecast-model", "Full (Three-Level) Model Name")
